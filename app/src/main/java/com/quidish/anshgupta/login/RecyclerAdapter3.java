...
public class RecyclerAdapter3 extends RecyclerView.Adapter<RecyclerAdapter3.MyHoder>{
    ...
    String userid;
     ...
     RecyclerAdapter3(List<FireModel> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull final MyHoder holder, final int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context,SoldActivity.class);
