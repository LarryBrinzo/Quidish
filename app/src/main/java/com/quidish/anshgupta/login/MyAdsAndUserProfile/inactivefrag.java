...
public class inactivefrag extends Fragment {
    ...
    List<AdModel> listinactive=new ArrayList<>();
    ...
    public void Adshowinactive(){
        ...
        else
        {
            ...
            if(adaptersh==1){
            MyAdsAdapter recyclerAdapter = new MyAdsAdapter(listinactive,getContext());
            ...
            if(adaptersh==2){
                UserAdsAdapter recyclerAdapter = new UserAdsAdapter(listinactive,getContext());
                RecyclerView.LayoutManager recyce = new GridLayoutManager(getContext(),1);
                recycle.setLayoutManager(recyce);
                recycle.setItemAnimator( new DefaultItemAnimator());
                recycle.setAdapter(recyclerAdapter);}
