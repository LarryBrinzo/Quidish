...
class WelcomeActivity : AppCompatActivity() , GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,com.google.android.gms.location.LocationListener{
        ...
        search.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(st: CharSequence, start: Int, before: Int, count: Int) {
                ...
                if (newText.length > 1) {
                    ...
                    ref = FirebaseDatabase.getInstance().reference.child("Institutes")
    ...
    override fun onLocationChanged(location: Location) {
        ...
        try {
            ...
            if (addresses.isEmpty()) {
                ...
                var add = returnedAddress.getAddressLine(0)
                add = add.toLowerCase()
                var found = "0"
                ...
                for (i in adds.indices) {
                    if (add.contains(adds.get(i).first.toLowerCase())) {
                        ...
                        searchhint.putString("userinstitute", adds[i].first)
                        searchhint.putString("userinstituteid", adds[i].second)
            ...
            when (status.statusCode) {
                ...
                LocationSettingsStatusCodes.RESOLUTION_REQUIRED ->
                    ...
                    try {
                        ...
                        status.startResolutionForResult(this@WelcomeActivity, REQUEST_CHECK_SETTINGS)
