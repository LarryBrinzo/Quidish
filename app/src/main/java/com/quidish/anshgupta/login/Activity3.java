...
public class Activity3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,ConnectivityReceiver.ConnectivityReceiverListener{
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (tunreadmsg > 0 && MessageActivity.work==2) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                            ...
                            builder = new NotificationCompat.Builder(Activity3.this, "0");

                            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP |
                                    Intent.FLAG_ACTIVITY_SINGLE_TOP);
                            pendingIntent = PendingIntent.getActivity(Activity3.this, 1251, intent, PendingIntent.FLAG_ONE_SHOT);
                            ...
                            pendingIntent = PendingIntent.getActivity(Activity3.this, 0, intent, 0);

                            Uri defaultSoundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
                            NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(Activity3.this)
