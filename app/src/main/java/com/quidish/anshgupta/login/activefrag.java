...
public class activefrag extends Fragment {
    ...
    List<FireModel> listactive=new ArrayList<>();
    ...
    public void Adshowactive(){
        ...
        else
        {
            ...
            if(adaptersh==1){
            RecyclerAdapter2 recyclerAdapter = new RecyclerAdapter2(listactive,getContext());
            ...
            recycle.setAdapter(recyclerAdapter);}
                ...
                RecyclerAdapter recyclerAdapter = new RecyclerAdapter(listactive,getContext());
                RecyclerView.LayoutManager recyce = new GridLayoutManager(getContext(),1);
                recycle.setLayoutManager(recyce);
                recycle.setItemAnimator( new DefaultItemAnimator());
                recycle.setAdapter(recyclerAdapter);
