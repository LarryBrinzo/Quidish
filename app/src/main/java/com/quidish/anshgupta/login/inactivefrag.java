...
public class inactivefrag extends Fragment {
     ...
     * @return A new instance of fragment inactivefrag.
     */
    // TODO: Rename and change types and number of parameters
    public static inactivefrag newInstance(String param1, String param2) {
        inactivefrag fragment = new inactivefrag();
    ...
    List<FireModel> listinactive=new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        view=  inflater.inflate(R.layout.fragment_inactivefrag, container, false);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(int i=si-1;i>=0;i--) {
                    ...
                    if(adsold==null || adsold.equals("0"))
                        continue;
                  ...
                  //  String category = dataSnapshot.child(ad_no).child("category").getValue(String.class);
                    ...
                    if(Activity3.listwish.contains(ad_no))
                        fire.setWish("1");

                    else
                        fire.setWish("0");

                        listinactive.add(fire);
    ...
    public void Adshowinactive(){
        ...
        else
        {
            ...
            if(adaptersh==1){
            RecyclerAdapter3 recyclerAdapter = new RecyclerAdapter3(listinactive,getContext());
            ...
            if(adaptersh==2){
                RecyclerAdapter recyclerAdapter = new RecyclerAdapter(listinactive,getContext());
                RecyclerView.LayoutManager recyce = new GridLayoutManager(getContext(),1);
                recycle.setLayoutManager(recyce);
                recycle.setItemAnimator( new DefaultItemAnimator());
                recycle.setAdapter(recyclerAdapter);}
